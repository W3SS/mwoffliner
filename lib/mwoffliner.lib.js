                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 4:
                                ...
                                articleDetailXId[articleId] = Object.assign(articleDetailXId[articleId] || {}, {
        ...
        function getMainPage() {
            ...
            function createMainPage() {
                ...
                var doc = domino_1.default.createDocument(articleListHomeTemplate
                    ...
                    '\n</head>'));
                var titles = Object.keys(articleDetailXId);
                var articlesWithImages = titles.reduce(function (acc, title) {
                ...
                articlesWithImages = articlesWithImages.sort(function (a, b) { return a.articleIndex > b.articleIndex ? 1 : -1; });
